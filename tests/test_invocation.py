...
from pydantic_sarif.sarif import Invocation, ArtifactLocation
...
def test_invocation_from_dict():
    ...
    full_dict = {
        ...
        "stdin": {
            "uri": "file:///project/stdin.txt"
        },
        "stdout": {
            "uri": "file:///project/stdout.txt"
        },
        "stderr": {
            "uri": "file:///project/stderr.txt"
        },
        "stdoutStderr": {
            "uri": "file:///project/stdout_stderr.txt"
        },
        "properties": {
            "exitCode": 0
        }
